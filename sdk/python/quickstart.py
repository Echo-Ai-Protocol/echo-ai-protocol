...
def main() -> int:
    ...
    client = EchoClient(base_url=args.base_url)
    ...
    stored_eo = client.store_object("eo", eo, skip_signature=args.skip_signature)
    eo_id = eo["eo_id"]
    ...
    stored_rr = client.store_object("rr", rr, skip_signature=args.skip_signature)
